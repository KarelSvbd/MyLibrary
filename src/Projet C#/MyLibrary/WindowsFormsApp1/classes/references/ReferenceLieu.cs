...
namespace MyLibrary
{
    public class ReferenceLieu : Reference
    {
        ...
        public override bool PostReference(Utilisateur utilisateur)
        {
            ...
            return ClientRest.Instance.AppelSimple("?table=references&email=" + utilisateur.Email + "&password=" + utilisateur.Password + "&nomReference=" + NomReference + "&descriptionLieu=" + DescriptionLieu + "&idLivre=" + IdLivre.ToString() + "&idType=" + IdType.ToString() + "", "PUT");
        }
